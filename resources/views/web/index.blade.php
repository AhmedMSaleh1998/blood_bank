        ...
        <div class="container">
            ...
            <div class="patients">
                <div class="details">
                    ...
                    <ul>
                        <li><span>اسم الحالة:</span>{{ $donnationRequest->patient_name }}</li>
                        <li><span>مستشفى:</span>{{ $donnationRequest->hospital_name }}</li>
                    </ul>
            ...
            @endforeach
            <div class="more">
                <a href={{ route('client.donnationRequests') }}>المزيد</a>
            </div>
