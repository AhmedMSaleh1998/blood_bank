...
<div class="container mt-5 w-25 p-3">
  <h2 class="text-center text-dark">city Edit</h2>
  <form method="post" action="{{ route('cities.update',$city->id) }}">
    ...
    <div class="mb-3 mt-3">
      ...
      <input type="name" class="form-control" id="name" placeholder="Enter City Name" name="name" value= {{old('city')?old('city'):$city->name}}>
    </div>
    <div class="mb-3">
